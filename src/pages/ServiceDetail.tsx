...
const serviceContent: Record<string, {
  ...
  achat: {
    ...
    intro: "Acheter un bien immobilier au Mali est une decision importante. DS Conseil vous accompagne de la definition de votre besoin jusqu'à la signature, en vous evitant les pieges courants du marche local.",
    howWeHelp: [
  ...
  location: {
    ...
    whatYouGet: [
      ...
      "Un suivi jusqu'à votre installation",
    ],
  ...
  vente: {
    ...
    whatYouGet: [
      ...
      "Un suivi jusqu'à la finalisation de la vente",
    ],
